...
<head>
    ...
    <title>-NicMoney - Dashboard</title>
...
/* CSS untuk memastikan kedua card memiliki tinggi yang sama */
.card-stats {
    display: flex;
...
/* Tambahan styling untuk elemen-elemen di dalam card */
.icon-big {
    font-size: 2em;
    color: white;
}

.card-category.ket.head {
    font-weight: bold;
}

.card-title.ket.total {
    font-size: 1.5em;
}
    </style>
</head>
...
<body>
    <div class="header">
        ...
        <h3 class="text-secondary font-weight-bold float-left logo">Nic</h3>
        <h3 class="text-secondary float-left logo2">Money</h3>
        <a href="logout">
            <div class="logout">
                    ...
                    <div class="row tampilCardview" id="row">
                        ...
                        <div class="col-md-4 jarak">
                            <a href="tambahPemasukkan" style="text-decoration: none;">
                                ...
                                <div class="col-lg-9">
                                    <canvas id="myChart" width="130px" height="50px"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
  ...
  if (!myLandbot) {
    ...
    s.addEventListener('load', function() {
      var myLandbot = new Landbot.Livechat({
        configUrl: 'https://storage.googleapis.com/landbot.online/v3/H-2565878-YQKZUZQFHIOGYJZR/index.json',
      });
    });
...
  }
    ...
    <script>
        ...
        var myChart = new Chart(ctx, {
            type: 'horizontalBar',
            data: {
                labels: ["Data Pemasukan", "Data Pengeluaran"],
                datasets: [{
                    label: 'Data Pemasukan & Pengeluaran',
                    data: [
                        <?= $totalMasuk ?>, 
                        <?= $totalKeluar ?>
                    ],
