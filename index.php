...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top main-nav" id="mainNav">
        <div class="container">
            ...
            <a class="navbar-brand js-scroll-trigger" href="#page-top">NicMoney</a>
    ...
    <header id="home" class="text-light parallax">
        <div class="container konten">
            <h1 style="font-size: 36pt;">Welcome to NicMoney</h1>
    ...
    <section id="features" class="bg-light">
        <div class=" container konten2">
            ...
            <div class="col-lg-12 foot-fitur">
                <h4 class="headline text-center">NicMoney</h4>
                <p class="isi-fitur text-center">NicMoney merupakan aplikasi web pencatatan keuangan harian yang
                    mempunyai fitur-fitur menarik untuk memonitoring keuangan harian bisnis. Direkomendasikan bagi para
                    UMKM
                    yang kesulitan dalam mengelola keuangannya. </p>
            </div>
            ...
            <div class="row row2">
                ...
                <div class="col-lg-6 fiturs">
                    ...
                    <p class="isi-fitur">
                        ...
                        harian yang bisa mempermudah anda dalam mengelola keuangan bisnis, dan data keuangan anda akan
            ...
            <div class="row row2">
                <div class="col-lg-6 fiturs text-right">
                    <h4 class="headline">Rekening bisnis</h4>
                    <p class="isi-fitur">Kami menyediakan fitur rekening bisnis yang dapat mempermudah anda dalam
            ...
            <div class="row row2">
                ...
                <div class="col-lg-6 fiturs">
                    ...
                    <p class="isi-fitur">Monitoring keuangan tentunya sangat diperlukan untuk mengelola pengeluaran dan
                        pemasukan bisnis. kami menyediakan dashboard yang berisi beberapa fitur, seperti saldo, total
                ...
                <div class="col-lg-8 mx-auto">
                    ...
                    <div class="row text-center">
                        ...
                        <a href="https://www.instagram.com" target="_blank">
                                ...
                                <img src="https://img.icons8.com/color/480/000000/instagram-new.png" width="30%">
                            </a>
                        </div>
                        <div class="col col2">
                            <a href="https://www.whatsapp.com" target="_blank">
                                <!-- <img src="icons/whatsapp.png" width="30%"> -->
                                <img src="https://img.icons8.com/color/480/000000/whatsapp.png" width="30%">
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container text-light">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 p-3">
                    <h5> <b>About</b> </h5>
                    <p class="mb-0">Aplikasi NicMoney dilengkapi dengan fitur menarik yang dapat mempermudah user mengelola keuangannya.</p>
                </div>
                <div class="col-lg-3 col-md-6 p-3">
                    <h5> <b>Follow us</b> </h5>
                    <div class="row">
                        <div class="col-md-5 d-flex align-items-center justify-content-between my-2">
                            <a href="https://www.instagram.com" class="foot-link" target="_blank">
                                <i class="d-block fa fa-instagram warna-icon fa-lg mx-2"></i>
                            </a>
                            <a href="https://www.whatsapp.com" class="foot-link" target="_blank">
                                <i class="d-block fa fa-whatsapp warna-icon fa-lg mx-2"></i>
                            </a>
                        </div>
                    </div>
                </div>
